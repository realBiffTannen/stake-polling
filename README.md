...
<a href="docs/screenshots/overview.png"><img src="docs/screenshots/overview.png" width="49%" alt="Overview: today since 00:00 UTC, in charts"></a> <a href="docs/screenshots/analysis.png"><img src="docs/screenshots/analysis.png" width="49%" alt="Analysis: donuts, P/L by game and the span picker"></a>
...
| Route | What it shows |
|---|---|
| `/` | **Overview.** Today since 00:00:00 UTC - the Engine dashboard's day - in charts: KPI tiles for studio P/L, turnover, bets, players online and RTP, each against the same hours of yesterday; the running studio P/L across the day with yesterday behind it; turnover (stacked by game) and P/L hour by hour; a game-by-hour turnover heat grid; P/L and turnover share by game; players online through the day; and a month-to-date strip. |
| `/games` | **Games.** The catalogue: every title, live or not, with its Engine star rating, status, revenue model, approval stage and a link to its page on the studio, its lifetime bets, players, turnover and studio P/L, and a ▸ that opens the row into this month's figures, the captured math and its bet modes; plus the titles not yet live with their captured math. Every table sorts by any column: click a heading, again to reverse. |
