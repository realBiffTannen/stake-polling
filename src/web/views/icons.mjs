/**
 * The dashboard's few UI icons, inline SVG drawn in currentColor so they take
 * the colour of whatever holds them. Constants, so safe to emit raw.
 */

import { raw } from '../html.mjs';

const svg = (paths) => raw(`<svg class="icon" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${paths}</svg>`);
